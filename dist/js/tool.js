...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "flex border-b-2 border-50" }, [
        _c("div", { staticClass: "w-1/5 px-8 py-2" }, [
          _c(
            "label",
        ...
        _vm._v(" "),
        _c("div", { staticClass: "w-4/5 py-2 px-8 relative" }, [
          _vm.filterString
            ? _c(
                "span",
                {
                  ...
                  attrs: { title: _vm.__("Clear filter") },
                  on: {
          ...
          _c("input", {
            ...
            attrs: {
              type: "text",
              placeholder: _vm.__("Filter") + ": By key or translation"
            },
        ...
        ? _c(
            ...
            [
              _c(
                ...
                {
                  staticClass:
                    "bg-white px-8 pt-2 border-b-2 border-50 overflow-x-auto overflow-y-hidden"
                },
                [
                  _c(
                    "div",
                    ...
                    _vm._l(_vm.filterdTranslations, function(
                      translation,
                      group
                    ) {
                      return _c(
                        ...
                        [
                          _vm._v(
                            "\n          " +
                              _vm._s(group) +
                              " (" +
                              _vm._s(Object.keys(translation).length) +
                              ")\n        "
                          )
                        ]
                      )
              ...
              _vm._v(" "),
              _vm._l(_vm.filterdTranslations, function(translation, group) {
                return _vm.currentGroup === group
                  ? _c("div", { key: group + "tab" }, [
                      _c("table", { staticClass: "table overflow-x-auto" }, [
                        _c("thead", [
                          _c(
                            "tr",
                            [
